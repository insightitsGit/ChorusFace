...
from aiface.biomechanics.muscles import Muscle, MuscleRegistry
...
def build_tissue_maps(
    ...
    *,
    ...
    ``face`` is an :class:`aiface.seed.FaceBox`. When ``landmarks`` are provided
    (from :mod:`aiface.landmarks`), eyes and mouth follow the measured centres
