...
sequence comes from :func:`chorusface.speech.tokenize_speech`, the same phonetic
...
that lag is a measurement rather than a claim. :mod:`chorusface.sync` runs the same
...
#: real synthesised speech with :mod:`chorusface.sync`, not chosen by taste.
...
class StreamConfig:
    ...
    def lookahead_frames(self) -> int:
        ...
        rate estimate, and :mod:`chorusface.sync` measures both separately.
        """
