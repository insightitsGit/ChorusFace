...
from chorusface.runtime.bds import GRID_HEIGHT, GRID_WIDTH
from chorusface.seed import AvatarSeedError, FaceBox, _cv2, write_portrait
...
def write_eye_anchors(
    ...
    *,
    ...
    payload = {
        "schema": "chorusface.eye_anchors.v1",
        "method": method,
        "image_width": width,
        "image_height": height,
...
def analyze_frame(
    ...
    *,
    ...
    """
    from chorusface.landmarks import eye_aperture_score, measure_landmarks, normalize_face_image
    from chorusface.seed import detect_face
    ...
    from chorusface.plates import teeth_visibility_score
...
def render_capture_qa(
    ...
    from chorusface.landmarks import FaceLandmarks, render_seed_qa
...
def _merge_capture_into_seed_metadata(
    ...
    from chorusface.runtime.bds import load_bds, save_bds
...
def _write_expression_catalog(
    ...
    *,
    ...
    from chorusface.expression_catalog import (
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"Play with: chorusface --world {result.world.as_posix()}")
    return 0
