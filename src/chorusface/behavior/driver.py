...
from chorusface.live_vector.features import (
    heuristic_vector,
    rms_history_features,
    sample_envelope_rms,
)
from chorusface.observation.extract import load_avatar_observations
from chorusface.observation.schema import AvatarObservationSet
...
class BehaviorDriver:
    ...
    def _table_state(self, phoneme: str) -> BehaviorState:
        ...
        from chorusface.mouth_cell_plan import viseme_flow
