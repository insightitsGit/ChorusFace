...
from chorusface.behavior.schema import CONTROL_DIM, CONTROL_NAMES, landmarks_to_controls
...
def _cell_geometry(world: Path) -> CellGeometryObs:
    ...
    try:
        ...
        from chorusface.mouth_cell_plan import detect_mouth_cells
        from chorusface.mouth_groups import build_mouth_group_plan
