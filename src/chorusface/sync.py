...
The offline aligner in :mod:`chorusface.tts` sees a whole clip before it decides
anything, so it is the best alignment this codebase can produce. The streaming
channel in :mod:`chorusface.stream` sees the same audio arriving in chunks and has to
...
from chorusface.audio import AudioClip, rms_envelope
from chorusface.speech import PhonemeSpan, tokenize_speech
...
from chorusface.tts import DEFAULT_WARP_STRENGTH, align_by_energy
