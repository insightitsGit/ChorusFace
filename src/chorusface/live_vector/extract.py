...
from chorusface.audio import DEFAULT_VOICE_THRESHOLD, decode_wav, rms_envelope
from chorusface.live_vector.features import rms_history_features
from chorusface.live_vector.schema import (
    CONTROL_NAMES,
    DATASET_CSV_NAME,
    HISTORY,
    dataset_path,
...
def _label_video(
    ...
    if landmarker_model is not None and landmarker_model.is_file():
        ...
        if labeled is not None:
            return labeled
    from chorusface.capture import MIN_SHARPNESS_SOFT, iter_video_frames
