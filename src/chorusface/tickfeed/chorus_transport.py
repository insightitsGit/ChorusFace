...
DEFAULT_INLINE_MAX = int(os.environ.get("CHORUSFACE_CHORUS_TPK_INLINE_MAX", "4096"))
# Trim spool every N writes (not every push) — NTFS glob/sort is expensive.
DEFAULT_TRIM_EVERY = int(os.environ.get("CHORUSFACE_CHORUS_SPOOL_TRIM_EVERY", "60"))
    ...
    def __init__(
        ...
        *,
        ...
        self.control_plane = control_plane or os.environ.get(
            "CHORUSFACE_CHORUS_CONTROL", "localhost:50051"
        )
        self.target = target or os.environ.get(
            "CHORUSFACE_CHORUS_TARGET", "localhost:50053"
        )
