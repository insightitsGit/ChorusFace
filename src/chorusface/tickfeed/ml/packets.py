...
SPEECH_CLOCK_SCHEMA: Final = "chorusface.packet.SpeechClock.v1"
LOOK_DRIVE_SCHEMA: Final = "chorusface.packet.LookDrive.v1"
FACE_MOTION_CODE_SCHEMA: Final = "chorusface.packet.FaceMotionCode.v1"
