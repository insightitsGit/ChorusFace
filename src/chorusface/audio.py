...
class _TempWavSink:
    ...
    def __init__(self) -> None:
        self._directory = Path(tempfile.mkdtemp(prefix="chorusface-audio-"))
...
def default_sink_preference() -> str:
    """Backend name from ``CHORUSFACE_AUDIO_BACKEND``, else automatic selection."""
    return os.environ.get("CHORUSFACE_AUDIO_BACKEND", "auto")
