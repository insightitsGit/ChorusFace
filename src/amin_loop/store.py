...
def describe_world_store(world_dir: Path) -> dict[str, Any]:
    ...
    roles = {
        ...
        "avatar_profile.json": "Adoption contract — any qualifying world dir",
        ...
        "cell_transition_track.npz": "Measured mouth-group transitions from upload",
        "cell_transition_track.json": "Human-readable transition samples + deltas",
        "behavior_model.joblib": "ML fill for missing transitions / live speech",
        "behavior_model.meta.json": "Behavior model train metrics",
